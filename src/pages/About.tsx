...
const About = () => {
  ...
  return (
    <div className='relative w-full min-h-screen bg-[#0d111c] text-white py-20 px-4 overflow-hidden'>
      ...
      <div className='absolute inset-0 w-full h-full z-0 opacity-50 bg-gradient-to-r from-[#00b7eb]/20 to-transparent' />
      ...
      <div className='relative max-w-7xl mx-auto z-10'>
        ...
        <section
          ref={sectionRefs[0]}
          className='bg-[#1a1f2b]/80 rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-cyan-500/50 mb-12'
        >
          <h1 className='text-4xl sm:text-5xl font-bold text-[#00b7eb] mb-4'>
            Sobre Nós
          </h1>
        ...
        >
          <div className='bg-[#1a1f2b]/80 rounded-xl p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-cyan-500/50'>
            <div className='flex items-center gap-4 mb-4'>
              <Target className='text-[#00b7eb] w-8 h-8' />
          ...
          <div className='bg-[#1a1f2b]/80 rounded-xl p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-cyan-500/50'>
            <div className='flex items-center gap-4 mb-4'>
              <Globe className='text-[#00b7eb] w-8 h-8' />
        ...
        <section
          ...
          className='bg-[#1a1f2b]/80 rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-cyan-500/50 mb-12'
        >
          <h3 className='text-3xl font-semibold text-[#00b7eb] mb-6'>
            Nossa História
          </h3>
          <div className='relative'>
            {/* Timeline Line */}
            <div className='absolute left-4 top-0 h-full w-1 bg-[#00b7eb]/50' />
            {/* Timeline Items */}
            <div className='space-y-8'>
              <div className='relative pl-12'>
                <div className='absolute left-0 top-0 w-8 h-8 bg-[#00b7eb] rounded-full flex items-center justify-center'>
        ...
        <section
          ref={sectionRefs[3]}
          className='relative flex justify-center items-center h-96 bg-[#1a1f2b]/80 rounded-xl shadow-lg transition-all duration-300 hover:shadow-cyan-500/50'
        >
